...
import { PAGINATION, PUBLIC_ROOM } from '../../../shared/constants/index.ts'
...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  async getMessages(@ConnectedSocket() client: Socket, @MessageBody() { page }: { page: number }) {
  ...
  async createMessage(
    ...
    @MessageBody()
    {
      ...
      size,
      page
    }: { message: string; type: string; userId: string; size: string; page: number }
  ) {
